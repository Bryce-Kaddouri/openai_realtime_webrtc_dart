...
Map<String, dynamic> _$UsageToJson(_Usage instance) => <String, dynamic>{
  ...
  'output_token_details': ?instance.outputTokenDetails,
};
...
_SessionConfig _$SessionConfigFromJson(Map<String, dynamic> json) =>
    _SessionConfig(
      type:
          $enumDecodeNullable(_$SessionConfigTypeEnumMap, json['type']) ??
...
const _$SessionConfigTypeEnumMap = {SessionConfigType.realtime: 'realtime'};
...
Map<String, dynamic> _$FormattedItemToJson(_FormattedItem instance) =>
    <String, dynamic>{'item': instance.item, 'formatted': instance.formatted};
